...
// also compile and run RunDetached.java before running this class
...
public class DownloadResult {
    ...
    public void downloadResult(int pid) throws Exception {
        int statuscode;
