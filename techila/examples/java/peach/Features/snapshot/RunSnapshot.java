...
// also compile SnapshotDist.java before running this example
...
/**
 * Techila Snapshot usage example with peach.
 */
public class RunSnapshot {
    ...
    public void runsnapshot() throws Exception {
        int statuscode;
        ...
        try {
            ...
            peach.addExeFile("file1", "SnapshotDist.class");
            peach.setJavaExecutable();
            peach.putExeExtras("Parameters", "SnapshotDist %P(jobidx) %P(loops) %O(output)");
            peach.putExeExtras("SnapshotFiles", "snapshot.dat");
            peach.putExeExtras("SnapshotInterval", "5");

            peach.setJobs(10);
            peach.putProjectParam("loops", "1000000000");
    ...
    public static void main(String[] args) {
        RunSnapshot rs = new RunSnapshot();
