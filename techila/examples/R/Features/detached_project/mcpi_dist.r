...
mcpi_dist <- function(loops) {
  ...
  # Return the number of points inside the unitary circle and the
  # total number of loops performed during the computational Job.
  return(list(count = count, loops = loops))
}
